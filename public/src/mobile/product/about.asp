					...
					<ul class="prd_list">
						<li>
							<dl>
								<dt>
									<strong>농산물</strong>
									<img src="/pjtCom/mobile/images/sub/img_product_about01.jpg" alt="" />
								</dt>
								<dd>
									<ul>
						...
						<li>
							<dl>
								<dt>
									<strong>수산물</strong>
									<img src="/pjtCom/mobile/images/sub/img_product_about02.jpg" alt="" />
								</dt>
								<dd>
									<ul>
						...
						<li>
							<dl>
								<dt>
									<strong>축산물</strong>
									<img src="/pjtCom/mobile/images/sub/img_product_about03.jpg" alt="" />
								</dt>
								<dd>
									<ul>
										<li>- 철저한 수입 이력 관리</li>
						...
						<li>
							<dl>
								<dt>
									...
									<img src="/pjtCom/mobile/images/sub/img_product_about04.jpg" alt="" />
								</dt>
								<dd>
									<ul>
										<li>- 제조 공정, 유통 단계별</li>
						...
						<li>
							<dl>
								<dt>
									...
									<img src="/pjtCom/mobile/images/sub/img_product_about05.jpg" alt="" />
								</dt>
								<dd>
									<ul>
