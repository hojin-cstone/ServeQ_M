		...
		<div id="contents" class="<%= path2dir %>">
			<div class="<%= path3dir %>">
				...
				<section class="section sec2">
					...
					<div>
						<img src="/pjtCom/mobile/images/sub/img_brand_material01.jpg" alt="">
					</div>
				</section>
				<section class="section sec3">
					...
					<div>
						<img src="/pjtCom/mobile/images/sub/img_brand_material02.jpg" alt="">
					</div>
				</section>
				<section class="section sec4">
					...
					<div>
						<img src="/pjtCom/mobile/images/sub/img_brand_material03.jpg" alt="">
					</div>
				</section>
				<section class="section sec5">
					...
					<div>
						<img src="/pjtCom/mobile/images/sub/img_brand_material04.jpg" alt="">
					</div>
				</section>
				<section class="section sec6">
					...
					<div>
						<img src="/pjtCom/mobile/images/sub/img_brand_material05.jpg" alt="">
					</div>
				</section>
			</div>
		</div>
