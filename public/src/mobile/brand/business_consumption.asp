		...
		<div id="contents" class="<%= path2dir %>">
			<div class="<%= path3dir %>">
				...
				<section class="section sec2">
					...
					<div class="img_box">
						<div class="l_img">
							<img src="/pjtCom/mobile/images/sub/img_brand_consum01.jpg" alt="" />
						</div>
						<a href="http://www.qone.co.kr/">
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_consum07.jpg" alt="큐원" />
							</div>
							<span>홈페이지 바로가기</span>
						</a>
					</div>
				...
				<section class="section sec3">
					...
					<div class="img_box">
						<div class="l_img">
							<img src="/pjtCom/mobile/images/sub/img_brand_consum02.jpg" alt="" />
						</div>
						<a href="http://www.qone.co.kr/Introduce/Homemade">
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_consum08.jpg" alt="큐원 홈메이드 홈페이지 바로가기" />
							</div>
							<span>홈페이지 바로가기</span>
						</a>
					</div>
				...
				<section class="section sec4">
					...
					<div class="img_box">
						<div class="l_img">
							<img src="/pjtCom/mobile/images/sub/img_brand_consum03.jpg" alt="" />
						</div>
						<a href="http://www.qone.co.kr/Introduce/Trusweet">
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_consum09.jpg" alt="트루스위트 홈페이지 바로가기" />
							</div>
							<span>홈페이지 바로가기</span>
						</a>
					</div>
				...
				<section class="section sec5">
					...
					<div class="img_box">
						<div class="l_img">
							<img src="/pjtCom/mobile/images/sub/img_brand_consum04.jpg" alt="" />
						</div>
						<a href="http://www.qone.co.kr/Introduce/Sangkwaehwan">
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_consum10.jpg" alt="상쾌한 홈페이지 바로가기" />
							</div>
							<span>홈페이지 바로가기</span>
						</a>
					</div>
				...
				<section class="section sec6">
					...
					<div class="img_box">
						<div class="l_img">
							<img src="/pjtCom/mobile/images/sub/img_brand_consum05.jpg" alt="" />
						</div>
						<a href="https://www.aboutmeshop.com/">
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_consum11.jpg" alt="ABOUT ME 홈페이지 바로가기" />
							</div>
							<span>홈페이지 바로가기</span>
						</a>
					</div>
				...
				<section class="section sec7">
					...
					<div class="img_box">
						<div class="l_img">
							<img src="/pjtCom/mobile/images/sub/img_brand_consum06.jpg" alt="" />
						</div>
						<a href="https://www.aboutmeshop.com/page/medianswer">
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_consum12.jpg" alt="MediAnswer 홈페이지 바로가기" />
							</div>
							<span>홈페이지 바로가기</span>
						</a>
					</div>
