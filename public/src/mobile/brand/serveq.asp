		...
		<div id="contents" class="<%= path2dir %>">
			<div class="<%= path3dir %>">
				<section class="section sec1">
					<div>
						<img src="/pjtCom/mobile/images/sub/img_brand_serveq01.jpg" alt="" />
					</div>
					<p>
						<strong>
				...
				<section class="section sec2">
					...
					<dl>
						...
						<dd>
							...
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_serveq02.jpg" alt="ServeQ" />
							</div>
						</dd>
					</dl>
					<dl>
						...
						<dd>
							...
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_serveq03.jpg" alt="The Best Solution ServeQ" />
							</div>
						</dd>
					</dl>
				</section>
				...
				<section class="section sec4">
					...
					<dl>
						<dt>Brand Slogan</dt>
						<dd>
							<img src="/pjtCom/mobile/images/sub/img_brand_serveq05.jpg" alt="The Best Solution" />
						</dd>
					</dl>
					<dl>
						<dt>Communication Slogan</dt>
						<dd>
							<img src="/pjtCom/mobile/images/sub/img_brand_serveq06.jpg" alt="고객 성공의 파트너 서브큐" />
						</dd>
					</dl>
				</section>
