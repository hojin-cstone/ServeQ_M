			...
			<div class="<%= path3dir %>">
				...
				<section class="section sec3">
					...
					<ul>
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi03.jpg" alt="MUTT LOGO" />
							</div>
							<strong>
								MUTT<br />
								이탈리아
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi04.jpg" alt="ANTONIOAMATO LOGO" />
							</div>
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi05.jpg" alt="EURIAL LOGO" />
							</div>
							<strong>
								EURIAL<br />
								프랑스
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi06.jpg" alt="DMK LOGO" />
							</div>
							<strong>
								DMK<br />
								독일
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi07.jpg" alt="Fonterra LOGO" />
							</div>
							<strong>
								Fonterra<br />
								뉴질랜드
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi08.jpg" alt="CEMOI LOGO" />
							</div>
							<strong>
								CEMOI<br />
								프랑스
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi09.jpg" alt="Coup de pates LOGO" />
							</div>
							<strong>
								Coup de pates<br />
								프랑스
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi10.jpg" alt="ARYZTA LOGO" />
							</div>
							<strong>
								ARYZTA<br />
								아일랜드
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi11.jpg" alt="METTE MUNK LOGO" />
							</div>
							<strong>
								METTE MUNK<br />
								덴마크
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi12.jpg" alt="OTISSPUNKMEYER LOGO" />
							</div>
							<strong>
								OTISSPUNKMEYER<br />
								미국
				...
				<section class="section sec4">
					...
					<dl>
						<dt>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi13.jpg" alt="">
							</div>
						...
						<dt>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi14.jpg" alt="">
							</div>
						...
						<dt>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi15.jpg" alt="">
							</div>
				...
				<section class="section sec6">
					...
					<ul>
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi17.jpg" alt="">
							</div>
							<div class="txt">
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi18.jpg" alt="">
							</div>
							<div class="txt">
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi19.jpg" alt="">
							</div>
							<div class="txt">
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_brand_busi20.jpg" alt="">
							</div>
							<div class="txt">
