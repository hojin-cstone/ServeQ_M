		...
		<div id="contents" class="<%= path2dir %>">
			<div class="<%= path3dir %>">
				...
				<section class="section sec2">
					...
					<div class="aryzta">
						<div>
							<img src="/pjtCom/mobile/images/sub/img_brand_bakery03.jpg" alt="ARYZTA Food Solutions SERVING INSPIRATION" />
						</div>
						<strong>
							아리스타
						</strong>
					...
					<ul class="alliance">
						<li>
							<div class="img_box">
								<img src="/pjtCom/mobile/images/sub/img_brand_bakery05.jpg" alt="coup de pates LOGO" />
							</div>
							<div class="txt">
								<dl>
									<dt>
						...
						<li>
							<div class="img_box">
								<img src="/pjtCom/mobile/images/sub/img_brand_bakery06.jpg" alt="Mette Munk LOGO" />
							</div>
							<div class="txt">
								<dl>
									<dt>
						...
						<li>
							<div class="img_box">
								<img src="/pjtCom/mobile/images/sub/img_brand_bakery07.jpg" alt="OtisSpunkmeyer LOGO" />
							</div>
							<div class="txt">
								<dl>
									<dt>
