			...
			<div class="<%= path3dir %>">
				...
				<div class="step2_area">
					...
					<ul class="calculator_list">
						<li>
							<a class="choose" href="/mobile/service/calculator_step2_recipe.asp">
								<img src="/pjtCom/mobile/images/sub/img_service_calculator_westurn.jpg" alt="">
								<b>양식 레시피</b>
							</a>
						</li>
						<li>
							<a class="choose" href="/mobile/service/calculator_step2_recipe.asp">
								<img src="/pjtCom/mobile/images/sub/img_service_calculator_chinese.jpg" alt="">
								<b>중식 레시피</b>
							</a>
						</li>
						<li>
							<a class="choose" href="/mobile/service/calculator_step2_recipe.asp">
								<img src="/pjtCom/mobile/images/sub/img_service_calculator_baking.jpg" alt="">
								<b>제과제빵 레시피</b>
							</a>
						</li>
					</ul>
