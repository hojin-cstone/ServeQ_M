		...
		<div id="contents" class="<%= path2dir %>">
			<div class="<%= path3dir %>">
				...
				<article class="bbs_gallery_view view_area">
					<div class="info_area">
						<figure class="img"><img src="/pjtCom/mobile/images/temp/img_service_view01.jpg" alt=""></figure>
						...
						<div class="product_area">
							<div class="inner swiper-container">
								<ul class="result_list recommend_list swiper-wrapper">
									<!-- 반복영역 // -->
									<li class="swiper-slide">
										<a href="/mobile/service/recipe_view_baking.asp">
											<img src="/pjtCom/mobile/images/temp/img_service_rlw01.jpg" alt="" class="img">
					...
					<a href="/mobile/service/recipe_list_western.asp" class="btn_list">목록</a>
				</article>
