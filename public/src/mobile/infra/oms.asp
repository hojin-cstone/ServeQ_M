			...
			<div class="<%= path3dir %>">
				...
				<section class="section sec2">
					<ul>
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_infra_oms05.jpg" alt="" />
							</div>
							<dl>
								<dt>영업</dt>
								<dd>
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_infra_oms06.jpg" alt="" />
							</div>
							<dl>
								<dt>SCM</dt>
								<dd>
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_infra_oms07.jpg" alt="" />
							</div>
							<dl>
								<dt>구매</dt>
								<dd>
						...
						<li>
							<div>
								<img src="/pjtCom/mobile/images/sub/img_infra_oms08.jpg" alt="" />
							</div>
							<dl>
								<dt>물류</dt>
								<dd>
				...
				<div class="btn_area">
					<a href="http://oms.samyang.com">
						<img src="/pjtCom/mobile/images/sub/img_infra_oms09.jpg" alt="OMS 시스템 바로가기" />
					</a>
				</div>
			</div>
		</div>
