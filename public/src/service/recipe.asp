				...
				<ul class="recipe_type">
					<li class="westurn">
						<a href="/service/recipe_list_western.asp">
							...
							<img src="/pjtCom/images/sub/img_recipe_westurn.jpg" alt="" class="img">
						</a>
					</li>
					<li class="chinese">
						<a href="/service/recipe_list_chinese.asp">
							...
							<img src="/pjtCom/images/sub/img_recipe_chinese.jpg" alt="" class="img">
						</a>
					</li>
					<li class="baking">
						<a href="/service/recipe_list_baking.asp">
							...
							<img src="/pjtCom/images/sub/img_recipe_baking.jpg" alt="" class="img">
						</a>
					</li>
					<li class="counsel">
						<a href="/service/recipe_counsel.asp">
							...
							<img src="/pjtCom/images/sub/img_recipe_counsel.jpg" alt="" class="img">
						</a>
					</li>
				</ul>
			</div>
